    ...
    <section id="skills" className="bg-slate-100">
      <div className="mx-auto max-w-5xl px-4 py-20">
        <div className="max-w-3xl space-y-4">
          <p className="text-xs font-semibold uppercase tracking-[0.3em] text-slate-500">Czego się uczę</p>
          <h2 className="text-3xl font-semibold text-slate-900 sm:text-4xl">
            Utrwalam podstawy programowania w Go, Pythonie i C.
          </h2>
          <p className="text-base leading-relaxed text-slate-600">
            Zamiast wielkich projektów stawiam na systematyczne ćwiczenia: małe skrypty, powtarzanie wzorców i analizę
            błędów. Z czasem chcę łączyć te umiejętności w większych zadaniach backendowych.
          </p>
        </div>
        ...
        <div className="mt-12 rounded-2xl border border-sky-100 bg-sky-50 p-6 text-sm leading-relaxed text-slate-700">
          <p>
            Szukam mentorskiego feedbacku i zadań, które pozwolą mi rosnąć. Dokumentuję proces w repozytoriach, opisuję
            napotkane problemy i sprawdzam, jakie nawyki pomagają utrzymać regularność nauki.
          </p>
        </div>
      </div>
    </section>
