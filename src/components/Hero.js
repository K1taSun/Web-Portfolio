    ...
    <section id="home" className="bg-slate-900 text-slate-100">
      <div className="mx-auto flex min-h-[70vh] max-w-5xl flex-col justify-center gap-8 px-4 py-24">
        <p className="text-sm font-semibold uppercase tracking-[0.35em] text-sky-300">
          Uczę się: Golang • C • Python
        </p>
        <h1 className="text-4xl font-bold leading-tight sm:text-5xl md:text-6xl">
          Cześć! Jestem Nikita Parkovskyi
          <span className="block text-sky-300">i stawiam pierwsze kroki jako programista backendu i systemów.</span>
        </h1>
        <p className="max-w-3xl text-lg text-slate-200 md:text-xl">
          Poznaję podstawy Go, C i Pythona: tworzę proste API, ćwiczę pracę z pamięcią w C i automatyzuję zadania w Pythonie.
          Każdy mały projekt traktuję jak okazję do nauki narzędzi i dobrych praktyk.
        </p>
